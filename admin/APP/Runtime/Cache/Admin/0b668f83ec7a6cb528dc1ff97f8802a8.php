							...
							<div class="widget-content nopadding">
									<div class="control-group">
										...
										<tbody>
											...
											<tr class="gradeX">
												<?php if(is_array($picture)): foreach($picture as $key=>$p): ?><td style="text-align:center">[<a href="<?php echo U('Admin/Message/modifypicture');?>">修改</a>]</td><?php endforeach; endif; ?>
											</tr>
										</tbody>
									</table> 
									</div>
									...
									<div class="control-group">
										...
										<tbody>
											<?php if(is_array($message1)): foreach($message1 as $key=>$m1): ?><tr class="gradeX">
												...
												<td style="text-align:center">[<a href="<?php echo U('Admin/Message/modifypage',array('mid'=>$m1['m_id']));?>">修改</a>]</td><?php endforeach; endif; ?>
											<?php if(is_array($message2)): foreach($message2 as $key=>$m2): ?><tr class="gradeX">
												...
												<td style="text-align:center">[<a href="<?php echo U('Admin/Message/modifypage',array('mid'=>$m2['m_id']));?>">修改</a>]</td><?php endforeach; endif; ?>
										</tbody>
									</table> 
									</div>
							</div>
